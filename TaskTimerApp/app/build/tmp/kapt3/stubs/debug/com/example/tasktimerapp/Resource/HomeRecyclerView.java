...
public final class HomeRecyclerView extends androidx.recyclerview.widget.RecyclerView.Adapter<com.example.tasktimerapp.Resource.HomeRecyclerView.ItemViewHolder> {
    ...
    private java.util.List<com.example.tasktimerapp.Model.Task> tasks;
    ...
    private final void stopTimer(com.example.tasktimerapp.Model.Task task, android.widget.Chronometer chronometer) {
    }
    
    private final void restartTimer(com.example.tasktimerapp.Model.Task task, android.widget.Chronometer chronometer) {
    }
    ...
    java.util.List<com.example.tasktimerapp.Model.Task> tasks) {
    }
